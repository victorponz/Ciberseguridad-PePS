...
Después hay que configurar nuestras variables de entorno para no tener que usar `sudo` al instalar **gemas** (las gemas son como los paquetes de **composer**)
...
* `jekyll serve`: hace lo mismo, excepto que se reconstruye cada vez que se realiza un cambio y ejecuta un servidor web local en http://localhost:4000.

![1547636039260](/assets/jekyll/1547636039260.png)
...
![localhost](/assets/jekyll/1547636528231.png)
...
![Github Web Pages](/assets/jekyll/1547636457711.png)

Y ahora vistamos https://victorponz.github.io/

![1547636567403](/assets/jekyll/1547636567403.png)
...
![Liquid](/assets/jekyll/1547636874493.png)
...
![navigation](/assets/jekyll/1547641761185.png)
...
![page.url](/assets/jekyll/1547642695047.png)
...
![Menú con YAML](/assets/jekyll/1547743023998.png)
...
Primero crea un archivo Sass en `//assets/jekyll/css/styles.scss` con el siguiente contenido:
...
<html>
  <head>
    <meta charset="utf-8">
    <title>{{ page.title }}</title>
    <link rel="stylesheet" href="//assets/jekyll/css/styles.css">
  </head>
  <body>
    {% include navigation.html %}
    {{ content }}
...
![scss](/assets/jekyll/1547743756709.png)
...
![Lista de blogs](/assets/jekyll/1547745125732.png)

![Entrada de blog](/assets/jekyll/1547745202892.png)

### Más posts

Crear una nueva entrada es tan sencillo como crear otro archivo en `_posts`

Por ejemplo, `_posts/2019-01-17-headless-cms.md`
...
![1547745581454](/assets/jekyll/1547745581454.png)

![1547745619372](/assets/jekyll/1547745619372.png)



## Actualizar nuestro repo

Ya sólo nos queda subir los cambios a **GitHub** y ya tenemos nuestra página personal.

![1547746402189](/assets/jekyll/1547746402189.png)
...
![1547746473642](/assets/jekyll/1547746473642.png)
...
![1547803981952](/assets/jekyll/1547803981952.png)
...
![1547803168281](/assets/jekyll/1547803168281.png)
...
![1547803310328](/assets/jekyll/1547803310328.png)
...
![1547747539220](/assets/jekyll/1547747539220.png)

Y completad el formulario con la url de vuestra página personal de **GitHub**

![1547747606148](/assets/jekyll/1547747606148.png)

Seleccionad la opción **Free**!!

![1547747685245](/assets/jekyll/1547747685245.png)

Finalmente, elegid Jekyll

![1547747717160](/assets/jekyll/1547747717160.png)

Ahora lo único que hay que hacer es modificar `post.html` con el código que provee **Disqus**
...
![Disqus](/assets/jekyll/1547804249547.png)
