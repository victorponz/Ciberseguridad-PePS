...
También existen los propios programas Sandbox (como [Sandboxie](https://github.com/sandboxie-plus/Sandboxie/releases)) cuyo propósito es ejecutar una aplicación en un entorno estanco que, en casa de error, no afecte a los demás programas.
...
El comando `pull` obtiene la **imagen** alpina del **registro del Docker** y la guarda en nuestro sistema. En este caso el registro es **[Docker Hub](<https://hub.docker.com>)**.
