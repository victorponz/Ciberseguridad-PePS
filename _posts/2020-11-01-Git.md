...
![Local](/img/git-basico/flow0.png)
...
![Life Cycle](/img/git-basico/lifecycle.png)
...
Para traer los cambios realizados en `master` a tu copia local
...
> **Nota importante**.
>
> El Instituto dispone de cuentas para todos el alumnado, así que es mejor que uséis dicha cuenta. Si no la conocéis preguntad.
...
![image-20201110183906307](/img/git-basico/image-20201110183906307.png)

### Crear un repositorio

Una vez registrados, haced clic en el botón "_Read the guide_" que os guiará para crear un nuevo repositorio en `github`.

![](.//img/git-basico/gh3.png)

Una vez creado, el aspecto de dicho repositorio será parecido a esto:

![](.//img/git-basico/gh4.png)Una vez creado el repositorio en `github` vamos a clonarlo para usarlo en nuestro ordenador.
...
![](/img/git-basico/bitbucket-min.gif)
...
5. Ahora añadir la url del reposositorio remoto
...
![image-20201110182858422](/img/git-basico/image-20201110182858422.png)

También podéis usar el siguiente curso en [PluralSight](https://www.pluralsight.com/courses/code-school-git-real)

![image-20201110183200149](/img/git-basico/image-20201110183200149.png)
