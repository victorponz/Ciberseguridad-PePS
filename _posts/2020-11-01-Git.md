...
![Local](assets/img/git-basico/flow0.png)
...
![Life Cycle](assets/img/git-basico/lifecycle.png)
...
![Local](assets/img/git-basico/flow.png)
...
![](assets/img/git-basico/flow2.png)
...
![image-20201110183906307](assets/img/git-basico/image-20201110183906307.png)

### Crear un repositorio

Una vez registrados, haced clic en el botón "_Read the guide_" que os guiará para crear un nuevo repositorio en `github`.

![](assets/img/git-basico/gh3.png)

Una vez creado, el aspecto de dicho repositorio será parecido a esto:

![](assets/img/git-basico/gh4.png)Una vez creado el repositorio en `github` vamos a clonarlo para usarlo en nuestro ordenador.
...
![](assets/img/git-basico/bitbucket-min.gif)
...
![image-20201110182858422](assets/img/git-basico/image-20201110182858422.png)

También podéis usar el siguiente curso en [PluralSight](https://www.pluralsight.com/courses/code-school-git-real)

![image-20201110183200149](assets/img/git-basico/image-20201110183200149.png)
