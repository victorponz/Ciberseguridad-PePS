...
![Capa de entramado binario de HTTP/2](https://developers.google.com/web/fundamentals/performance/http2/images/binary_framing_layer01.svg?hl=es)
...
Y también cuidado con los [PunyCodes](https://es.wikipedia.org/wiki/Punycode). Por ejemplo si vistas esta web que parece legítima[](https://www.аррӏе.com/) ocurre lo siguiente:
...
>
> https://www.xataka.com/servicios/http-2-asi-va-a-mejorar-la-velocidad-de-tu-navegacion-sin-que-tu-tengas-que-hacer-nada
>
