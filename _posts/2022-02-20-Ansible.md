...
> -hint-La sintaxis de inventario también acepta rangos de servidores, por ejemplo, `www[01-22].company.com`. El puerto SSH también debe especificarse si es distinto de 22 (el predeterminado). Puedes leer más en la página oficial de Ansible en: [http://docs.ansible.com/ansible/intro_inventory.html](http://docs.ansible.com/ansible/intro_inventory.html).
